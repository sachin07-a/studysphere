...
export const MobileNav: React.FC = () => {
  const { activeView, setActiveView, isTimerRunning } = useStudy();
    ...
    <>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden bg-slate-950/80 backdrop-blur-xl animate-in fade-in duration-200">
          <div className="absolute bottom-20 left-4 right-4 rounded-3xl glass-panel p-5 border border-white/15 shadow-2xl">
            <div className="flex items-center justify-between pb-3 border-b border-white/10 mb-4">
              <span className="text-sm font-bold text-slate-100">All Sections</span>
              <button 
